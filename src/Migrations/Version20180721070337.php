 ...
 */
final class Version20180721070337 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE id_banque_id banque_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE banque_id id_banque_id INT NOT NULL');
    }
}
